...
\begin{abstract}
  ...
  We examine a three variants of order property which are prima facie non equivalent.
...
\begin{proof}
  ...
  Then induction for the existential quantifier follows from
    ...
    which is a consequence of saturation and the fact that if $C'$, $C''$ are compact neighbourhoods of $C$ then $\exists x \phi(x;C'\cap C'')$ is satisfiable.
