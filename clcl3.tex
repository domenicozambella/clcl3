...
\begin{definition}\label{def_finitary_stable}\strut
  ...
  We say finitarily \emph{stable\/} for not finitarily unstable.
\end{definition}
...
%   There is a sequence $\langle a_i\,;b_i\ :\ i<\omega\rangle$, some $C$, some $\tilde C\cap C=\varnothing$, and some formula $\varphi(x\,;z\,;X)\in\sigma$ such that\smallskip
...
\ceq{5.\hfill \langle b_n,C_n\rangle\in{\EuScript D}\ \ }{\text{and}}{\ \ \bigwedge_{i<n}\ {\sim}\sigma(a_i\,;b_n\,;\tilde C_{i,n})}%\smallskip
