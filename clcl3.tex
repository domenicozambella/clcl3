...
\begin{proof}
  ...
  The existential quantifier of sort {\sf H} is the only connective that require attention.
...
We write \emph{$K(S)$\/} for the set of compact subsets of $S^n$, for some $n$ which we leave implicit in the context.
...
If ${\EuScript D}\subseteq{\EuScript U}^z\times K(S)$ then ${\sim}{\EuScript D}$ is obtained by applying the definition above to all fibers of ${\EuScript D}$.
...
For regular ${\EuScript D}$ the above implications can be reversed.

\begin{fact}
  Let ${\EuScript D}$ be regular and approximable by $\varphi(x\,;z\,;X)$.
  Then for every finite $B\subseteq{\EuScript U}^z$ there is an $a\in{\EuScript U}^x$ such that\smallskip

\ceq{\hfill \langle b,C\rangle\in {\EuScript D}}{\Leftrightarrow}{\phantom{\sim}\varphi(a\,;b\,;C)}\quad and\smallskip

\ceq{\hfill \langle b,C\rangle\in{\sim}{\EuScript D}}{\Leftrightarrow}{{\sim}\varphi(a\,;b\,;C)}\hfill for all $b\in B$ and $C\in K(S)$.
\end{fact}

\begin{proof}
  For given $B$ let $a$ be as given by approximability. 
  Assume $\varphi(a\,;b\,;C)$ and, for a contradiction, $\langle b,C\rangle\notin{\EuScript D}$.
  As ${\EuScript D}={\sim}{\sim}{\EuScript D}$, there must be some $\tilde C\in{\sim}{\EuScript D}$ such that $\tilde C\cap C=\varnothing$.
  Then ${\sim}\varphi(a\,;b\,;\tilde C)$ by approximability.
  By Fact~\ref{fact_trivial} this contradicts $\varphi(a\,;b\,;C)$.
  The second equivalence is proved by a similar argument.
\end{proof}
...
\begin{theorem}[ (conjecture)]
  ...
  \ceq{\hfill\langle b,C\rangle\in{\sim}{\EuScript D}}{\Rightarrow}{\bigvee_{i=0}^n\ \bigwedge_{j=0}^n\ {\sim}\varphi(a_{i,j}\,;b\,;C)} \medskip

  for every $b\in{\EuScript U}^z$ and $C\in K(S)$.
\end{theorem}
...
\begin{lemma}[ (conjecture)]
  If ${\EuScript D}$ is approximable from below then there are some $\langle a_i\ :\ i<n\rangle$ such that\medskip

  \ceq{\hfill\langle b,C\rangle\in{\EuScript D}}{\Rightarrow}{\bigvee_{i=0}^n\ \varphi(a_i\,;b\,;C)} \medskip
  
  \ceq{\hfill\langle b,C\rangle\in{\sim}{\EuScript D}}{\Rightarrow}{\bigwedge_{i=0}^n\ {\sim}\varphi(a_i\,;b\,;C)} \medskip
