...
In this section we recall the basic properties of the \textit{structures with a standard sort\/} in \cite{clcl}, which offers an alternative framework to describe continuous structures using classical logic. 
We refer the reader to the introduction of \cite{clcl} or~\cite{Z}.
