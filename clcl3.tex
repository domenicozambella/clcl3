...
\begin{fact}
  For every $C\subseteq C'$ there is a $\tilde C$ disjoint from $C$ such that\smallskip
  ...
  Conversely, for every $\tilde C\cap C=\varnothing$ there is a $C'$ neighboorhood of $C$ such that
