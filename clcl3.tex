...
\begin{proof}
  ...
  \hfil $C_i\subseteq C^{\varepsilon/2}$,\quad $C\subseteq C_i^{\varepsilon/2}$\hfil and \hfil$\tilde C_i\subseteq\tilde C^{\varepsilon/2}$,\quad $\tilde C\subseteq\tilde C_i^{\varepsilon/2}$.\hfil

  Then $C^{\varepsilon/2}\cap\tilde C^{\varepsilon/2}\varnothing$ and therefore together with a suitable subsequence of $\langle a_i\,;b_i\ :\ i<\omega\rangle$ yield a counter example to stability. 
\end{proof}
...
The following is a weaker notion of approximation.


\begin{definition}\label{def_e_approx_X}\strut
  We say that ${\EuScript D}$ is \emph{$\varepsilon$-approximable\/} by $\varphi(x\,;z\,;X)$ \emph{from below\/} if for every finite $B\subseteq{\EuScript U}^z$ there is an $a\in{\EuScript U}^x$ such that for every $C$\smallskip

  \ceq{1.\hfill \langle b,C\rangle\in{\EuScript D}}{\Rightarrow}{\varphi(a\,;b\,;C)}\hfill for every $b\in B$ and and\smallskip
...
\begin{lemma}
  Let $\varphi(x\,;z\,;X)$ be stable.
  Assume that ${\EuScript D}$ is $\varepsilon$-approximable by $\varphi(x\,;z\,;X)$ from below.
  Then there is are some $\langle a_i\ :\ i<k\rangle$ such that for every $b\in{\EuScript U}^z$ and every $C$\medskip
...
\begin{lemma}
  ...
  $\varepsilon$-approximate ${\EuScript D}$ from below.
\end{lemma}
