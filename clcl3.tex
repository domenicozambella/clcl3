...
Under the assumption of the remark it is easy to verify by compactness that in Definition~\ref{def_approx} the requirement \textit{for every small\/} $B$ can be replaced by \textit{for every finite\/} $B$.
...
\ceq{5.\hfill \langle b_n,C_n\rangle\in{\EuScript D}\ \ }{\text{and}}{\ \ \bigwedge_{i<n}\ {\sim}\sigma(a_i\,;b_n\,;\tilde C_n)}%\smallskip

Suppose for a contradiction that the construction never ends.
Then, as (5) guarantees that $\langle b_i,C_i\rangle\in{\EuScript D}$ for every $i$, from (4) we obtain $\sigma(a_n\,;b_i\,;C_n)$ for every $i<n$.
...
\begin{proof}
  ...
  In fact, from (3) we obtain ${\sim}\sigma(a_n\,;b_i\,;\tilde C_i)$ for every $i<n$.
