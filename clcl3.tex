...
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Pseudocomplement in \boldmath$K(S)$}\label{pseudocomplement}
...
For ${\EuScript D}\subseteq K(S)$ we define 
...
\begin{fact}\label{fact_~inclusione}
  For every ${\EuScript D}\subseteq{\EuScript C}\subseteq K(S)$ we have ${\sim}{\EuScript C}\subseteq{\sim}{\EuScript D}$.  
...
\begin{fact}
  For every ${\EuScript D}\subseteq K(S)$ the following are equivalent
  \begin{itemize}
    \item [1.] ${\EuScript D}={\sim}{\sim}{\EuScript D}$.
    \item [2.] ${\EuScript D}={\sim}{\EuScript C}$ for some ${\EuScript C}\subseteq K(S)$.
  \end{itemize}
\end{fact}
  
\begin{proof}
  Only 2$\Rightarrow$1 requires a proof.
  From the two claims in the above fact we obtain ${\sim}{\sim}{\sim}{\EuScript C}\subseteq{\sim}{\EuScript C}$.
  Then form (2) we obtain ${\sim}{\sim}{\EuScript D}\subseteq{\EuScript D}$, which suffices to prove (1).
\end{proof}

We say that ${\EuScript D}$ is \emph{regular\/} if 

\ceq{\hfill C\in{\EuScript D}}{\Leftrightarrow}{C'\in{\EuScript D}} for every neighborhood $C'$ of $C$.

It is not difficult to see that ${\EuScript D}$ is regular if and only if it is closed in the Vietoris topology and includes all the supersets of its elements.

\begin{theorem}
  The following are equivalent
  \begin{itemize}
    \item [1.] ${\EuScript D}$ is regular 
    \item [2.] ${\EuScript D}={\sim}{\sim}{\EuScript D}$.
  \end{itemize}
\end{theorem}
...
\begin{proof}
  ...
  By regularity ($\Rightarrow$) every $C'\supseteq O$ is in ${\EuScript D}$.
  As $O$ is arbitrary, $C\in {\EuScript D}$ by regularity ($\Leftarrow$).

  2$\Rightarrow$1.
  It suffices to show that ${\sim}{\EuScript D}$ is regular.
  Regularity ($\Rightarrow$) is ovious.
  To prove regularity ($\Leftarrow$), assume $C\notin{\sim}{\EuScript D}$.
  Then $C\cap\tilde C$ for some $\tilde C\in{\EuScript D}$.
  Let $C'$ be a neighboorhood of $C$ disjoint of $C$.
  Then the r.h.s.\@ of the above equivalence fails for $C'$.  
\end{proof}
...
We say that ${\EuScript D}$ is \emph{approximable\/} by $\varphi(x\,;z\,;X)$ if for every finite $B\subseteq{\EuScript U}^z$ there is an $a\in{\EuScript U}^x$ such that

\ceq{\hfill \langle b,C\rangle\in {\EuScript D}}{\Leftrightarrow}{\phantom{\sim}\varphi(a\,;b\,;C)}\hfill for all $b\in B$ and $C\in K(S)$.

By Facts~\ref{fact_~definibile} and~\ref{fact_~inclusione} the equivalence above can be split into two imlications

\ceq{\hfill \langle b,C\rangle\in {\EuScript D}}{\Rightarrow}{\phantom{\sim}\varphi(a\,;b\,;C)}\quad and

\ceq{\hfill \langle b,C\rangle\in{\sim}{\EuScript D}}{\Rightarrow}{{\sim}\varphi(a\,;b\,;C)}\hfill for all $b\in B$ and $C\in K(S)$.

Or, symmetrically

\ceq{\hfill\varphi(a\,;b\,;C)}{\Rightarrow}{\langle b,C\rangle\in {\EuScript D}}\quad and

\ceq{\hfill{\sim}\varphi(a\,;b\,;C)}{\Rightarrow}{\langle b,C\rangle\in{\sim}{\EuScript D}}\hfill for all $b\in B$ and $C\in K(S)$.
...
\begin{proof}
  ...
  But implies that $C\in{\sim}{\sim}{\EuScript D}={\EuScript D}$, a contradiction.
  The second case is when ${\sim}\varphi(x\,;b\,;C)$ is consistent with $p(x)$ but $\langle b,C\rangle\notin{\sim}{\EuScript D}$.
  Then $\langle b,\tilde C\rangle\notin{\EuScript D}$ for every $\tilde C\cap C=\varnothing$.
  Then $\langle b,\tilde C\rangle\in{\sim}{\EuScript D}$, a contradiction.
\end{proof}
...
\begin{theorem}[ (conjecture)]
  ...
  Let $C\cap\tilde C=\varnothing$ be given.
  Then there are some $\langle a_{i,j}\ :\ i,j<n\rangle$ such that for every $b\in{\EuScript U}^z$\medskip

  \ceq{\hfill\langle b,C\rangle\in{\EuScript D}}{\Rightarrow}{\bigwedge_{i=0}^n\ \bigvee_{j=0}^n\ \varphi(a_{i,j}\,;b\,;C)} \medskip
  
  \ceq{\hfill\langle b,\tilde C\rangle\in{\sim}{\EuScript D}}{\Rightarrow}{\bigvee_{i=0}^n\ \bigwedge_{j=0}^n\ {\sim}\varphi(a_{i,j}\,;b\,;\tilde C)}
\end{theorem}
...
\begin{lemma}[ (conjecture)]
  Let $C\cap\tilde C=\varnothing$ be given.
  If ${\EuScript D}$ is approximable from below then there are some $\langle a_i\ :\ i<n\rangle$ such that for every $b\in{\EuScript U}^z$\medskip

  \ceq{\hfill\langle b,\tilde C\rangle\in{\EuScript D}}{\Rightarrow}{\bigvee_{i=0}^n\ \varphi(a_i\,;b\,;C)} \medskip
  
  \ceq{\hfill\langle b,\tilde C\rangle\in{\sim}{\EuScript D}}{\Rightarrow}{\bigwedge_{i=0}^n\ {\sim}\varphi(a_i\,;b\,;\tilde C).}
\end{lemma}
