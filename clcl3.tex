...
\begin{fact}\label{fact_trivial}
  The following hold for every $C\subseteq C'$ and $\tilde C\cap C=\varnothing$, every standard structure $M$, and every ${\EuScript F}_{\sf X}(M)$-formula $\varphi(X)$
...
\begin{definition}\label{def_stable_inf}\strut
  ...
  \ceq{\hfill \sigma(a_n\,;b_i\,;C)}{\wedge}{{\sim}\varphi(a_i\,;b_n\,;\tilde C)}\smallskip
...
\ceq{\hfill \sigma(a_n\,;b_i\,;C)}{\wedge}{{\sim}\sigma(a_i\,;b_n\,;\tilde C)}\smallskip
...
\begin{proof}
  ...
  To obtain a counter example to (2), set $C_i=C$ and $\tilde C_i=\tilde C$ for every $i<\kappa$. 

  \noindent\llap{\textcolor{red}{\Large\warning}\kern1.5ex}\ignorespaces
  1$\Rightarrow$2. 
  Negate (2).
  Pick $\varepsilon$ and $\langle a_i\,;b_i\,;C_i\,;\tilde C_i\ :\ i<\kappa\rangle$ that are a counter example to (1) in Definition~\ref{def_epsilon_stable}.
  By the compactness of $K(S)$ in the Vietoris topology, for every $\delta$ there are $C$ and $\tilde C$ such that for infinitely many $i<\kappa$ we have
  ...
  Then, as $C_i^{2\delta}\cap\tilde C_i=\varnothing$, for every $i<\kappa$.
  Then $C^\delta\cap\tilde C_i=\varnothing$, for every $i<\kappa$.
...
\begin{theorem}\label{thm_epsilon_stability_definability}
  ...
  \ceq{\hfill \langle b,C\rangle\in{\EuScript D}}{\Rightarrow}{\bigvee_{i<\omega}\ \bigwedge_{j<\omega}\ \varphi(a_{i,j}\,;b\,;C^\varepsilon)}\medskip

  \ceq{\hfill \langle b,C^\varepsilon\rangle\in{\EuScript D}}{\Leftarrow}{\bigvee_{i<\omega}\ \bigwedge_{j<\omega}\ \varphi(a_{i,j}\,;b\,;C)}
\end{theorem}
