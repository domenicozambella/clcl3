...
\begin{theorem}[ (conjecture)]
  ...
  \ceq{\hfill\langle b,C\rangle\in{\EuScript D}}{\Leftrightarrow}{\bigwedge_{i=0}^n\ \bigvee_{i=0}^n\ \varphi(a_{i,j}\,;b\,;C)} \medskip
...
\begin{lemma}
  ...
  \ceq{\hfill\langle b,C\rangle\in{\EuScript D}}{\Leftrightarrow}{\bigvee_{i=0}^n \varphi(a_i\,;b\,;C)} \medskip
