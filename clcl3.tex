...
We write $K$ for a set of compact subsets of $S^n$.  
Let ${\EuScript D}\subseteq K$.
We define 

\ceq{\hfill\emph{${\sim}{\EuScript D}$}}{=}{\big\{\tilde C\in K\ :\ \tilde C\cap C\neq\varnothing\text{ for every }C\in{\EuScript D}\big\}.}
...
\begin{proof}
  ...
  \ceq{\hfill{\sim}\varphi(\tilde C)}{\Leftrightarrow}{\text{for every } C,\ \ [C\cap\tilde C=\varnothing\rightarrow\neg\varphi(C)]}
