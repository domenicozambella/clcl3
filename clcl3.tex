...
\begin{definition}\label{def_approx_X}\strut
  ...
  \ceq{2.\hfill\varphi(a\,;b\,;C)}{\Rightarrow}{\langle b,C\rangle\in {\EuScript D}}\hfill for every $b\in B$ and every $C$.\smallskip
...
\begin{lemma}\label{lem_epsilon_stability_definability}
  ...
  Assme that ${\EuScript D}$ is $\varepsilon$-approximable by $\varphi(x\,;z\,;X)$.
...
\ceq{5.\hfill \langle b,C\rangle\in{\EuScript D}}{\&}{\bigwedge_{i=0}^n\ {\sim}\varphi(a_i\,;b_n\,;C_n)}%\smallskip

If such $b_n$ and $C_n$ do not exist, then 

\ceq{\hfill \langle b,C\rangle\in{\EuScript D}}{\Rightarrow}{{\sim}\bigvee_{i=0}^n\ \varphi(a_i\,;b\,;\tilde C)}\ \hfill for every $b\in{\EuScript U}^z$ and every $\tilde C\cap C^\varepsilon=\varnothing$%\smallskip
...
\begin{proof}
  ...
  \ceq{2.\hfill\varphi(a_n\,;b\,;C^\varepsilon)}{\Rightarrow}{\langle b,C\rangle\in{\EuScript D}}
  ...
  \ceq{\hfill \langle b_n,C\rangle\notin{\EuScript D}}{\&}{\bigwedge_{i=0}^n\ \varphi(a_i\,;b_n\,;C).}

  We claim that the sequence has to stop after $\le m$ steps. 
  Otherwise we contradict the maximality of $m$.
  In fact, from (3), and $\langle b_i,C\rangle\notin{\EuScript D}$ for everi $i$, we obtain ${\sim}\varphi(a_n\,;b_i\,;C_i)$ for every $i<n$.
  On the other hand, by (1) we have that $\varphi(a_n\,;b_i\,;C)$ for every $i<n$.
\end{proof}
