...
In this section, the letter $\varepsilon$ always denotes a definable compact neighborhood of the diagonal of $S^2$.
% By $\varepsilon+\delta$ we denote the composition $\varepsilon\circ\varepsilon$, where the two sets are viewed as relations.
If $C$ is a subset of $S$, we write $C^\varepsilon$ for the set of the points of $S$ that are $\varepsilon$-close to points of $C$.
