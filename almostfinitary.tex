...
\begin{definition}\label{def_epsilon_stable}\strut
  ...
  We say \emph{$\varepsilon$-stable\/} for not $\varepsilon$-unstable.    
\end{definition}
...
\ceq{5.\hfill \langle b_n,C_n\rangle\in{\EuScript D}\ \ }{\text{and}}{\ \ \bigwedge_{i<n}\ {\sim}\varphi(a_i\,;b_n\,;\tilde C_{i,n})}%\smallskip

Let $m$ witness the $\varepsilon$-stability of $\varphi(x\,;z\,;X)$.
Suppose for a contradiction that the construction curries on $m$ stages.
...
From (5) we also obtain, for every $i< n<m$, some $\tilde C_{i,n}\cap C_n=\varnothing$ such that ${\sim}\varphi(a_i\,;b_n\,;\tilde C_{i,n})$.
