...
\begin{definition}\label{def_approx_X}\strut
  ...
  \ceq{2'.\hfill\langle b,C^{\delta}\rangle\in {\EuScript D}}{\Leftarrow}{\varphi(a\,;b\,;C)}\hfill for every $b\in{\EuScript U}$ and every $C$.
...
\begin{theorem}\label{thm_epsilon_delta_stability_definability}
  ...
  \ceq{\hfill \langle b,C\rangle\in{\EuScript D}}{\Rightarrow}{\bigvee_{i< k}\ \bigwedge_{j<m}\ \varphi(a_{i,j}\,;b\,;C^{\delta})}\medskip

  \ceq{\hfill \langle b,C^{\delta}\rangle\in{\EuScript D}}{\Leftarrow}{\bigvee_{i< k}\ \bigwedge_{j<m}\ \varphi(a_{i,j}\,;b\,;C)}
\end{theorem}
