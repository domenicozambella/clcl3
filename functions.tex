...
\begin{fact}
  Let $\tau(x\,;z)$ be term in ${\EuScript L}$.
...
\end{fact}  
  ...
  We suspect the fact holds in general though we have not been able to prove it.
...
We say that $f$ is approximable by $\tau(x\,;z)$ is the equivalent conditions above apply.
The following is an easy consequence if Theorem~\ref{thm_stability_definability}
