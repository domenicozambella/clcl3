...
\begin{proof}
  ...
  \ceq{2.\hfill\bigvee_{i< m}\ \bigwedge_{j<m}\ \big|\tau(a_{i,j}\,;b)-f(b)\big|\le\varepsilon.}{ }{}

  We claim that we also have

  \ceq{3.\hfill\bigwedge_{i< m}\ \bigvee_{j<m}\ \big|\tau(a_{i,j}\,;b)-f(b)\big|\ \le\ \varepsilon.}{ }{}
  ...
  \ceq{4.\hfill f(b)\ -\ \min_{j<m}\ \tau(a_{i,j}\,;b)}{>}{\varepsilon}\hfill for every $i<m$\phantom{.}

  \ceq{5.\hfill \min_{j<m}\ \tau(a_{i,j}\,;b)\ -\ f(b)}{>}{\varepsilon}\hfill for some $i<m$.
