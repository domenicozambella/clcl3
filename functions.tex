...
%From the proof below it is clear that in the theorem the order of $\sup$ and $\inf$, respectively $\max$ and $\min$ can be reversed.
...
\begin{proof}
  ...
  We prove the second claim of the theorem.
